...
- Pick a region (e.g., `us-east-2`)
  - Dev/Test example: `chatpie-dev` (public GET on `uploads/` only if needed)
  - Prod example: `chatpie-prod` (private)
  ...
  "Statement": [
    {
      ...
      "Principal": "*",
      "Action": "s3:GetObject",
      "Resource": "arn:aws:s3:::chatpie-dev/uploads/*"
    }
  ]
}
```
